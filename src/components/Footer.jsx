...
const Footer = ({ className }) => {
  return (
    <div className={className} data-name="Footer" data-node-id="168:382">
      ...
      <div className="hidden md:flex gap-[50px] lg:gap-[277px] items-center justify-between w-full" data-node-id="168:380">
        <div className="flex gap-[15px] items-center" data-name="Social Links" data-node-id="168:327">
          <a href="#" className="relative shrink-0 size-[30px] lg:size-[35px] hover:opacity-80 transition-opacity" data-name="Linkedin" data-node-id="168:335">
          ...
          <a href="#" className="inline-grid relative shrink-0 hover:opacity-80 transition-opacity" data-name="Instagram" data-node-id="168:368">
          ...
          <a href="#" className="inline-grid relative shrink-0 hover:opacity-80 transition-opacity" data-name="Youtube" data-node-id="168:361">
        ...
        <div className="flex gap-[5px] items-end" data-node-id="168:360">
          <p className="font-mondwest leading-normal not-italic text-[14px] lg:text-[16px] text-nowrap text-white whitespace-pre">
            A product of{" "}
          </p>
          <div className="box-border flex flex-col h-[16px] lg:h-[18px] items-start px-[7px] lg:px-[8.667px] py-[3.5px] lg:py-[4.333px] relative w-[60px] lg:w-[68.833px]" data-name="logo" data-node-id="168:355">
            <div className="absolute flex flex-col font-youth justify-end leading-[0] left-0 not-italic text-primary-light text-[0px] text-nowrap top-[16px] lg:top-[18px] translate-y-[-100%]" data-node-id="168:356">
      ...
      <div className="md:hidden flex flex-col gap-[20px] items-center w-full py-4">
        <div className="flex gap-[15px] items-center justify-center" data-name="Social Links">
          <a href="#" className="relative shrink-0 size-[35px] hover:opacity-80 transition-opacity">
            <div className="absolute inset-[-2.143%]">
              <img alt="LinkedIn" className="block max-w-none size-full" src="/54e6392ffd4531523d2aea916e092f82390c9900.svg" />
            </div>
          </a>
          <a href="#" className="inline-grid relative shrink-0 hover:opacity-80 transition-opacity">
        ...
        <div className="flex gap-[5px] items-end justify-center">
          <p className="font-mondwest leading-normal not-italic text-[14px] text-nowrap text-white whitespace-pre">
            A product of{" "}
          </p>
          <div className="box-border flex flex-col h-[18px] items-start px-[8.667px] py-[4.333px] relative w-[68.833px]">
            <div className="absolute flex flex-col font-youth justify-end leading-[0] left-0 not-italic text-primary-light text-[0px] text-nowrap top-[18px] translate-y-[-100%]">
              <p className="leading-normal whitespace-pre">
        ...
        <div className="inline-grid relative text-center">
          <p className="font-mondwest leading-normal not-italic text-[12px] text-white">
            © 2025 Holdspace. All rights reserved
          </p>
        </div>
      </div>
